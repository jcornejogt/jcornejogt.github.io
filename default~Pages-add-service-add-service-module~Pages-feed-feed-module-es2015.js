...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseServiceService", function() { return FirebaseServiceService; });
...
let FirebaseServiceService = class FirebaseServiceService {
    ...
    getService(documentId) {
        return this.firestore.collection('servicios').doc(documentId).snapshotChanges();
    }
    updateService(documentId, data) {
        return this.firestore.collection('servicios').doc(documentId).set(data);
    }
};
FirebaseServiceService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
];
FirebaseServiceService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
//# sourceMappingURL=default~Pages-add-service-add-service-module~Pages-feed-feed-module-es2015.js.map