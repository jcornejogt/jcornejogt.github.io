...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~Pages-add-service-add-service-module~Pages-feed-feed-module"], {
  /***/
  ...
  function node_modulesFirebaseFirestoreDistIndexCjsJs(module, exports, __webpack_require__) {
    ...
    function () {
      ...
      return t.ol = function (e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = st(), s = 0; i && s < r.activeTargetIds.length; ++s) {
        ...
        this.zd = e, void 0 !== e.credentials && (this.Kd = function (t) {
          ...
          switch (t.type) {
            case "gapi":
              ...
              return d(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), new Mi(e, t.wu || "0");
      ...
      return e.__extends(n, t), n.sw = function (t, e, r) {
        ...
        var n,
          ...
          includeMetadataChanges: !1
            ...
            i = 0;
        "object" != typeof t[i] || Uo(t[i]) || (ti("DocumentReference.onSnapshot", r = t[i], ["includeMetadataChanges"]), Hr("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), i++);
        var o = {
    ...
    function (t) {
      ...
      n.prototype.pw = function (t, n, r, i) {
        ...
        var n,
            r = {},
            i = 0;
        return "object" != typeof t[i] || Uo(t[i]) || (ti("Query.onSnapshot", r = t[i], ["includeMetadataChanges"]), Hr("Query.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), i++), Uo(t[i]) ? n = t[i] : (Gr("Query.onSnapshot", "function", i, t[i]), zr("Query.onSnapshot", "function", i + 1, t[i + 1]), zr("Query.onSnapshot", "function", i + 2, t[i + 2]), n = {
          next: t[i],
          error: t[i + 1],
          complete: t[i + 2]
    ...
    ds(n), exports.__PRIVATE_registerFirestore = ds; //# sourceMappingURL=index.cjs.js.map
  ...
  /*! exports provided: FirebaseServiceService */

  /***/
  function srcAppServicesFirebaseServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FirebaseServiceService", function () {
      return FirebaseServiceService;
    });
    /* harmony import */
    ...
    var FirebaseServiceService = /*#__PURE__*/function () {
      function FirebaseServiceService(firestore) {
        _classCallCheck(this, FirebaseServiceService);

        this.firestore = firestore;
      }

      _createClass(FirebaseServiceService, [{
        key: "createService",
        ...
        key: "getService",
        value: function getService(documentId) {
          return this.firestore.collection('servicios').doc(documentId).snapshotChanges();
        }
      }, {
        key: "updateService",
        value: function updateService(documentId, data) {
    ...
    FirebaseServiceService.ctorParameters = function () {
      return [{
        type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]
      }];
    };

    FirebaseServiceService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], FirebaseServiceService);
    /***/
  }
}]);
//# sourceMappingURL=default~Pages-add-service-add-service-module~Pages-feed-feed-module-es5.js.map