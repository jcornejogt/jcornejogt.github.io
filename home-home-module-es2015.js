...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'add-service',
                loadChildren: () => Promise.all(/*! import() | Pages-add-service-add-service-module */[__webpack_require__.e("default~Pages-add-service-add-service-module~Pages-feed-feed-module"), __webpack_require__.e("Pages-add-service-add-service-module")]).then(__webpack_require__.bind(null, /*! ../Pages/add-service/add-service.module */ "./src/app/Pages/add-service/add-service.module.ts")).then(m => m.AddServicePageModule)
            }
        ]
    },
];
